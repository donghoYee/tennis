      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">대회 정보를 입력하여 토너먼트를 시작하세요</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              {errors.teamCount && (
                <p className="text-red-500 text-sm mt-1">{errors.teamCount}</p>
              )}
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <h3 className="font-medium text-gray-800 mb-2">대회 미리보기</h3>
