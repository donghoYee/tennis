    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">대회를 생성하고 관리하세요</p>
        </div>
        ...
        <div className="mb-8 text-center">
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg font-semibold 
                     shadow-lg transform transition duration-200 hover:scale-105 flex items-center gap-3 mx-auto"
          >
            <Plus size={24} />
            새 대회 만들기
          </button>
        ...
        {tournaments.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-600 mb-2">아직 대회가 없습니다</h3>
            <p className="text-gray-500">첫 번째 대회를 만들어보세요!</p>
          </div>
        ) : (
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-2 text-gray-600">
                    <div className="flex items-center gap-2">
                      <Users size={16} />
                      <span className="text-sm">{tournament.teamCount}팀 참가</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Calendar size={16} />
